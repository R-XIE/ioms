		...
		<div class="span12">
			...
			<div class="widget orange">
				<div class="widget-title">
					...
					<span class="tools"> <a href="javascript:;" id="index_refresh" data-url="${ctx}/permiss/roleActionList.htm"
					...
					<div>
						...
						<table class="table table-striped table-hover table-bordered"
							...
							<tbody>
								...
								<tr id="tr_${role.roleId}" class="">
									<td>${status.count}</td>
									<td>${role.roleName}</td>
									<td class="center">${role.roleDescription}</td>
									<td>
										<button class="btn btn-small btn-success" onclick="javascript:doAction('auth','${role.roleId}')">
											<i class="icon-ok icon-white"></i> 授权
										</button>
									</td>
									<td>
										<button class="btn btn-small btn-primary" onclick="javascript:doAction('edit','${role.roleId}','${role.roleName}','${role.roleDescription}')" >
											<i class="icon-pencil icon-white"></i> 编辑
										</button>
									</td>
									<td>
										<button class="btn btn-small btn-danger" onclick="javascript:doAction('del','${role.roleId}')">
...
<script src="${ctx}/custom/permiss/roleList.js"></script>