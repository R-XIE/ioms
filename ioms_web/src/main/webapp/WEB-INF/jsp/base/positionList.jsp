	...
	<div class="row-fluid">
		<div class="span12">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">岗位管理</a> <span class="divider">/</span></li>
		...
		<div class="span12">
			...
			<div class="widget red">
				<div class="widget-title">
					<h4>
						<i class="icon-reorder"></i>岗位列表
					</h4>
					<span class="tools"> <a href="javascript:;" id="index_refresh" data-url="${ctx}/base/positionActionList.htm"
						...
						<table class="table table-striped table-hover table-bordered"
							...
							<tbody>
								...
								<tr class="">
									...
									<td>${branchMap[position.branchId]}</td>
									<td>${position.positionDesc}</td>
									<td>
										<button class="btn btn-small btn-primary" onclick="javascript:doAction('edit','${position.positionId}')" >
											<i class="icon-pencil icon-white"></i> 编辑
										</button>
									</td>
									<td>
										<button class="btn btn-small btn-danger" onclick="javascript:doAction('del','${position.positionId}')">
...
<script src="${ctx}/custom/base/positionList.js"></script>