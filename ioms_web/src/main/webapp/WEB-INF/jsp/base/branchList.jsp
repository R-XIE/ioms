		...
		<div class="span12">
			...
			<div class="widget purple">
				<div class="widget-title">
					<h4>
						<i class="icon-reorder"></i>部门列表
					</h4>
					<span class="tools"> <a href="javascript:;" id="index_refresh" data-url="${ctx}/base/branchActionList.htm"
				...
				<div class="widget-body">
					<div>
						...
						<table class="table table-striped table-hover table-bordered"
							...
							<tbody>
								<c:forEach items="${list}" var="branch" varStatus="status">
								<tr class="">
									<td>${status.count}</td>
									<td>${branch.branchName}</td>
									<td>${branch.branchDesc}</td>
									<td>
										<button class="btn btn-small btn-primary" onclick="javascript:doAction('edit','${branch.branchId}','${branch.branchName}','${branch.branchDesc}')" >
											<i class="icon-pencil icon-white"></i> 编辑
										</button>
									</td>
									<td>
										<button class="btn btn-small btn-danger" onclick="javascript:doAction('del','${branch.branchId}')">
...
<script src="${ctx}/custom/base/branchList.js"></script>