...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<h3 class="page-title">图书类型管理</h3>
			<ul class="breadcrumb">
				<li><a href="#" onclick="javascript:ck_index();">主页</a> <span class="divider">/</span></li>
				<li><a href="#">图书类型管理</a> <span class="divider">/</span></li>
		...
		<div class="span12">
			...
			<div class="widget purple">
				<div class="widget-title">
					<h4>
						<i class="icon-reorder"></i>图书类型列表
					</h4>
					<span class="tools"> <a href="javascript:;" id="index_refresh" data-url="${ctx}/book/bookTypeActionList.htm"
				...
				<div class="widget-body">
					<div>
						...
						<table class="table table-striped table-hover table-bordered"
							...
							<tbody>
								<c:forEach items="${list}" var="bookType" varStatus="status">
								<tr class="">
									<td>${status.count}</td>
									<td>${bookType.bookTypeName}</td>
									<td>${bookType.bookTypeDesc}</td>
									<td>
										<button class="btn btn-small btn-primary" onclick="javascript:doAction('edit','${bookType.bookTypeId}','${bookType.bookTypeName}','${bookType.bookTypeDesc}')" >
											<i class="icon-pencil icon-white"></i> 编辑
										</button>
									</td>
									<td>
										<button class="btn btn-small btn-danger" onclick="javascript:doAction('del','${bookType.bookTypeId}')">
...
<script src="${ctx}/custom/book/bookTypeList.js"></script>